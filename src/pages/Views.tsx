  ...
  return (
    <>
      <Seo
        ...
        canonical={typeof window !== "undefined" ? `${window.location.origin}/views` : undefined}
      />
        ...
        <section aria-labelledby="views-title" className="py-6 md:py-8 lg:py-10">
          <div className="mx-auto w-[min(1200px,92%)]">
            <header className="mb-6 md:mb-8 text-center">
              <h1 id="views-title" className="text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight text-foreground drop-shadow-xl">
