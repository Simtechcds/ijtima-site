...
const Footer = () => {
  return (
    <footer className="mt-8 border-t border-border/60">
      <div className="container py-8 text-sm flex flex-col md:flex-row items-center md:items-start justify-between gap-4 md:gap-6">
        <p className="text-muted-foreground text-center md:text-left">© {new Date().getFullYear()} Ijtima Collection</p>
